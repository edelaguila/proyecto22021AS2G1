...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-08-2021 a las 21:00:04
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `conIndHorarioCi` (IN `id` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaSala` ()  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `ingresoHorario` (IN `fecha` VARCHAR(25))  BEGIN
...
--
-- Volcado de datos para la tabla `horariocine`
--

INSERT INTO `horariocine` (`idhorarioCine`, `fkPelicula`, `fkSala`, `fkHorario`) VALUES
(3, 1, 1, 1);
...
(3, '2021-08-14 17:22:00'),
(4, '2021-08-14 21:00:00'),
(5, '2021-08-11 17:44:22'),
(6, '2021-08-14 18:02:21');
...
--
ALTER TABLE `horariocine`
  MODIFY `idhorarioCine` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
